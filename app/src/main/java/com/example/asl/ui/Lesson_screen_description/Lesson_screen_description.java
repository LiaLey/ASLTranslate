package com.example.asl.ui.Lesson_screen_description;
...
import com.example.asl.controller.choice_message.One_choice_message;
...
public class Lesson_screen_description extends Sub_action_bar {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lesson_description_screen);
    ...
    private void set_translator_button_on_click(){
        ...
        if(category_elements.check_element_not_testable(correct_translator_label)){
            ...
            Lesson_screen_description lesson_screen = this;
