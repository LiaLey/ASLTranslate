package com.example.asl.ui.translator_verify;
...
import com.example.asl.controller.toast.Custom_toasts;
...
public class Translator_verify extends Sub_action_bar {
    ...
    private void get_context_and_activity(){
        translator_verify_context = Translator_screen.getContext_here();
        translator_verify_activity = Translator_screen.getActivity_here();
    }
    ...
    private void handle_complete(){
        ...
        new Custom_toasts(translator_verify_context, "Sign: \"" + correct_string.toUpperCase() + "\" was correct!").show_toast(false);
     ...
     */
    private void enable_or_disable_button(View button,boolean enable){
        if(enable){
            //Enable button
