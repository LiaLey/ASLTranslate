...
public class Almost_screen_components implements Lesson_screen_components {
    ...
    public int get_content_id(){
        return R.string.almost_content;
    }
